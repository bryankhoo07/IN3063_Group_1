...
file_path = os.path.abspath(os.path.join(current_dir, 'task_2_london_weather/london_weather.csv'))
...
if not os.path.exists(file_path):
    ...
    cleaned_file_path = os.path.join(current_dir, 'task_2_london_weather/london_weather_clean.csv')
